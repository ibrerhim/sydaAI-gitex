          ...
          <div className="container px-4 py-24 flex flex-col lg:flex-row items-center text-center lg:text-left relative z-10">
            <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl text-blue-50">
                Smart-Ops is an agentic AI assisatnt designed to helps SMEs sell easily across Africa through trusted social media platforms they already use. by simplifying and automating customer interactions ,order management and payment processing , all without needing any tech skills or expensive setups.
              </p>
